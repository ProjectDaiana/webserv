...
#define NO_LISTEN_BINDING    ERROR_PREFIX CLR_MAGENTA "Server has no listen binding!\n" CLR_RESET
...
#define EXPECTED_VALUE    ERROR_PREFIX CLR_MAGENTA "Parser Error: expected value for directive!\n" CLR_RESET
#define EXPECTED_SEMICOLON    ERROR_PREFIX CLR_MAGENTA "Parser Error: expected ';' after directive!\n" CLR_RESET
...
#define EXPECTED_LOCATION_BRACE    ERROR_PREFIX CLR_MAGENTA "Parser Error: expected '{' after location path!\n" CLR_RESET
#define EXPECTED_SERVER_BRACE    ERROR_PREFIX CLR_MAGENTA "Parser Error: expected '{' after 'server'!\n" CLR_RESET
#define UNEXPECTED_TOKEN    ERROR_PREFIX CLR_YELLOW "Parser Error: unexpected token!\n" CLR_RESET
#define BRACE_MISSING    ERROR_PREFIX CLR_YELLOW "Parser Error: expected brace is missing!\n" CLR_RESET
